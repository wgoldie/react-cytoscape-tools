  ...
  */
  ...
  function (_React$Component) {
    ...
    _createClass(CytoscapeView, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(React.Fragment, null, React__default.createElement(CytoscapeElementContainer, {
          cytoscape: cytoscape,
          cyInitJSON: cyInitJSON || cyJSON,
          style: style,
          className: className
        }, children), React__default.createElement(CytoscapeGate, null, React__default.createElement(CytoscapeController, null)));
      }
    }]);
  ...
  var Cytoscape = function Cytoscape(_ref) {
    var cytoscape = _ref.cytoscape,
        ...
        className = _ref.className,
        children = _ref.children;
    return React__default.createElement(CytoscapeProvider, null, React__default.createElement(CytoscapeView, {
      cytoscape: cytoscape,
      cyJSON: cyJSON,
